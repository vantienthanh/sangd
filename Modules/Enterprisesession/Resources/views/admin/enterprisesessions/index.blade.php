                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if (isset($enterprisesessions)): ?>
                            <?php foreach ($enterprisesessions as $enterprisesession): ?>
                            <tr>
                                <td>
                                    <a href="{{ route('admin.enterprisesession.enterprisesession.edit', [$enterprisesession->id]) }}">
                                        {{ $enterprisesession->created_at }}
                                    </a>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.enterprisesession.enterprisesession.edit', [$enterprisesession->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
...
@section('shortcuts')
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd>{{ trans('enterprisesession::enterprisesessions.title.create enterprisesession') }}</dd>
    </dl>
@stop
